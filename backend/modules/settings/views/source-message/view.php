...
<div class="giiant-crud source-message-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'SourceMessage'=>$copyParams],
    ...
    <?php $this->beginBlock('backend\modules\settings\models\SourceMessage'); ?>
...
<div style='position:absolute; right: 0px; top: 0px;'>
  <?= Html::a(
            '<span class="glyphicon glyphicon-list"></span> ' . 'List All' . ' Messages',
            ['message/index'],
            ['class'=>'btn text-muted btn-xs']
        ) ?>
  <?= Html::a(
            '<span class="glyphicon glyphicon-plus"></span> ' . 'New' . ' Message',
            ['message/create', 'Message' => ['id' => $model->id]],
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\settings\models\SourceMessage'],
    'active'  => true,
],
[
